      ...
      >
        ...
        <View style={{ paddingTop: 25 }}>
          ...
          >
            ...
            <TouchableOpacity>
              <Text
                style={{ color: "#00d5ff", fontSize: 15, fontWeight: "400" }}
              >
                See All
              </Text>
            </TouchableOpacity>
          ...
          >
            <TouchableOpacity
              style={{ alignItems: "center", gap: 5, height: "100%" }}
            >
              <View
                style={{
                  backgroundColor: "#ffffffac",
          ...
          >
            ...
            <View style={{ flex: 1, gap: 5 }}>
              <Text
                style={{ fontSize: 18, fontWeight: "600", color: "#4d4d4d" }}
              >
                Water Saving Tip
              </Text>
        ...
        <View style={{ paddingTop: 25, paddingBottom: 20 }}>
          <View
            style={{ paddingBottom: 20, width: "96%", alignSelf: "center" }}
          >
            <Text style={{ fontSize: 20, fontWeight: "700" }}>
              Recent Activity
            </Text>
          ...
          >
            ...
            <View style={{ gap: 5 }}>
              ...
              >
                <Text style={{ color: "gray" }}>24 Jan</Text>
                <Octicons name="dot-fill" size={10} color="gray" />
                <Text style={{ color: "gray" }}>ID #WTR-11019</Text>
              </View>
            </View>

            <View>
              <Text style={{ fontSize: 17, fontWeight: "700" }}>₹1,200</Text>
            </View>
          </View>
        </View>
            ...
            >
              <View style={{ gap: 5 }}>
                ...
                <View
                  style={{ flexDirection: "row", alignItems: "center", gap: 3 }}
                >
                  <Text style={{ color: "gray" }}>12 Jan</Text>
                  <Octicons name="dot-fill" size={10} color="gray" />
                  <Text style={{ color: "gray" }}>Pipe Leak Fix</Text>
                </View>
              </View>
